...
import static nosql.batch.update.reactor.aerospike.wal.AerospikeWriteAheadLogManager.getBytesFromUUID;
import static nosql.batch.update.reactor.util.AsyncUtil.shutdownAndAwaitTermination;

public class AerospikeExclusiveLocker implements ExclusiveLocker {

    private static Logger logger = LoggerFactory.getLogger(AerospikeExclusiveLocker.class);
