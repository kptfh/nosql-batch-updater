...
public class FlakingWriteAheadLogManager<LOCKS, UPDATES, BATCH_ID> implements WriteAheadLogManager<LOCKS, UPDATES, BATCH_ID> {
    ...
    public FlakingWriteAheadLogManager(WriteAheadLogManager<LOCKS, UPDATES, BATCH_ID> writeAheadLogManager, AtomicBoolean failsDelete) {
